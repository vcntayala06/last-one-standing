...
const REQUIRED_FILES=[
 ...
 "question-bank-batch-1.js","question-bank-batch-2.js","question-bank-batch-3.js","question-bank-batch-4.js","question-bank-batch-5.js","question-bank-batch-6.js",
...
test("installed game reloads and reaches a Champion through manual play with network removed",{timeout:60000},async()=>{
 ...
 try{
  ...
  const correctAnswer=await offlinePage.evaluate(()=>{const prompt=document.querySelector(".question-text")?.textContent?.trim(),sources=[window.LOS_QUESTION_BANK_DATA,window.LOS_QUESTION_BANK_BATCH_1,window.LOS_QUESTION_BANK_BATCH_2,window.LOS_QUESTION_BANK_BATCH_3,window.LOS_QUESTION_BANK_BATCH_4,window.LOS_QUESTION_BANK_BATCH_5,window.LOS_QUESTION_BANK_BATCH_6];return sources.flatMap(source=>source.questions).find(question=>question.prompt===prompt)?.answer?.canonical||null});

...
const WEST_COAST_FINAL_QUESTION=["Landscape","Portrait","Ultrawide"].map(format=>`assets/west-coast/runtime/final-showdown-question/Final_Showdown_${format}_LOCKED.png`);

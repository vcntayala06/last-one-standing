...
const rows=[
 ...
 ["sunline","What type of transportation does SunLine provide to the public in the Coachella Valley?","Public transit",["bus service","public transportation","transit service"],"Transit","easy"],
...
for(const [i,[kind,prompt,canonical,alts,subject,difficulty]] of rows.entries()){
 ...
 questions.push({schemaVersion:1,revision:1,id,prompt,subject,difficulty,answer:{conceptId:id+".answer",canonical,accepted:{en:[...new Set(accepted)],es:[]}},editions:["original","solo","work"],workTrack:kind==="work"?"dedicated":"broad",workSafe:true,kidsSafe:!["culture","para","sunline"].includes(kind),gradeRange:null,classification:kind==="riddle"?"entertainment":"mixed",educationalSubject:titles[kind],contentPacks:packs[kind],review:{status:"approved",reviewer:"Build 6.30 two-source editorial review",reviewedAt:VERIFIED_AT,approvalStandard:"stage-6.30"},fact:{sources:S[kind].map(x=>({...x,verifiedAt:VERIFIED_AT,confirmsAnswer:true,confirmsWording:true})),verifiedAt:VERIFIED_AT,dateSensitive:false,wordingFair:true,ambiguityChecked:true},quality:{status:"passed",reviewedAt:VERIFIED_AT,reviewer:"Build 6.30 editorial review",flags:[],los,riddle,notes:"Passed the No That Was Stupid Factor spoken-play review."}})
}
